...
class Search extends React.Component {
  constructor() {
    super();
    this.state = { data: null, selectedPark: 0 };
  ...
  componentWillMount() {
    fetch(
      'https://developer.nps.gov/api/v1/parks?limit=20&q=NAtional%20Park&fields=images&stateCode=AK&api_key=StrO7VmO29V3pT2CoZAkdAHxzJPNRjTa2QDpG37V'
    )
      .then((res) => res.json())
      .then((data) => {
        this.setState({ data });
  ...
  getData(e) {
    ...
    fetch(
      'https://developer.nps.gov/api/v1/parks?limit=20&q=NAtional%20Park&fields=images&stateCode=' +
        code +
        '&api_key=StrO7VmO29V3pT2CoZAkdAHxzJPNRjTa2QDpG37V'
    )
      .then((res) => res.json())
      .then((data) => {
        this.setState({ data });
